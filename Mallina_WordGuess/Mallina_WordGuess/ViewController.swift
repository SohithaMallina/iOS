...
//  Mallina_WordGuess
//
//  Created by Sohitha Mallina on 3/5/25.
//
...
class ViewController: UIViewController {
    ...
    let words :  [(String, String, String)] = [("APPLE","Fruit Name","apple"),
                                               ("JASMINE","Flower Name","jasmine"),
                                               ("POTATO","Vegetable Name","potato"),
                                               ("NWMSU","University Name", "nwmsu"),
                                               ("VIRAT","Cricketer", "virat")];
